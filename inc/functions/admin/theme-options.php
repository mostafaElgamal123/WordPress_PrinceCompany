<?php
    ...
    */
    ...
    function register_theme_options() {
        ...
        register_setting('tornado-options', 'footer_title1');
        register_setting('tornado-options', 'footer_title2');
        register_setting('tornado-options', 'footer_title3');
        register_setting('tornado-options', 'services_keywords');
        register_setting('tornado-options', 'blog_keywords');
        register_setting('tornado-options', 'testimony_keywords');
        register_setting('tornado-options', 'message_keywords');
        register_setting('tornado-options', 'meta_title_footer');
        register_setting('tornado-options', 'meta_content_footer');
        ...
        register_setting('tornado-options', 'background_logo');
