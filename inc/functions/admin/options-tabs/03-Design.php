...
<div class="options-panel">
    <!-- Panel Title -->
    <h2 class="panel-title"><?php echo __('Theme Concept','tornado'); ?></h2>
    <!-- Grid -->
    <div class="row no-gutter tx-align-center">
        <!-- Control Item -->
        <div class="control-item box-5x1 screen-checkbox <?php if (is_rtl()) { echo 'rtl'; }?>">
            <input type="radio" name="theme_style" value="modern-flat" checked>
            <div class="content-wraper ti-checkmark">
                <img src="https://via.placeholder.com/225x200" alt="" class="preview">
                <span><?php echo __('Modern Flat','tornado'); ?></span>
            </div>
        </div>
        <!-- Control Item -->
        <div class="control-item box-5x1 screen-checkbox <?php if (is_rtl()) { echo 'rtl'; }?>">
            <input type="radio" name="theme_style" value="neumorphism">
            <div class="content-wraper ti-checkmark">
                <img src="https://via.placeholder.com/225x200" alt="" class="preview">
                <span><?php echo __('Neumorphism','tornado'); ?></span>
            </div>
        </div>
        <!-- // Control Item -->
    </div>
...
<div class="options-panel <?php if (get_option('colors_palette') != 1) : echo 'disabled'; endif;?>">
    ...
    <div id="dark-colors" class="<?php if (get_option('dark_mode') !== 1) : echo 'hidden'; endif; ?> row no-gutter">
        <!-- Control Item -->
        <div class="control-item box-3x1 <?php if (is_rtl()) { echo 'rtl'; }?>">
            <div class="content-box align-between">
                <label for="dark_body_background">
                    <?php echo __('Body Background','tornado'); ?>
                    <span class="ti-help-mark help-btn" data-txt="<?php echo __('Theme Design Body Background Color','tornado'); ?>"></span>
                </label>
                <div class="color-picker">
                    <?php $color_val = get_option('dark_body_background'); ?>
                    <input type="text" name="dark_body_background" value="<?php echo $color_val; ?>" placeholder="<?php echo $color_val; ?>">
                    <div class="color-prev" style="background-color:<?php echo $color_val; ?>"></div>
                </div>
            </div>
        </div>
        ...
        <div class="control-item box-3x1 <?php if (is_rtl()) { echo 'rtl'; }?>">
            <div class="content-box align-between">
                <label for="dark_headlines_color">
                    <?php echo __('Headlines Text','tornado'); ?>
                    <span class="ti-help-mark help-btn" data-txt="<?php echo __('Theme Design Headlines Text Color','tornado'); ?>"></span>
                </label>
                <div class="color-picker">
                    <?php $color_val = get_option('dark_headlines_color'); ?>
                    <input type="text" name="dark_headlines_color" value="<?php echo $color_val; ?>" placeholder="<?php echo $color_val; ?>">
                    <div class="color-prev" style="background-color:<?php echo $color_val; ?>"></div>
                </div>
            </div>
        </div>
        ...
        <div class="control-item box-3x1 <?php if (is_rtl()) { echo 'rtl'; }?>">
            <div class="content-box align-between">
                <label for="dark_typography_color">
                    <?php echo __('Normal Text','tornado'); ?>
                    <span class="ti-help-mark help-btn" data-txt="<?php echo __('Theme Design Paragraphs Text Color','tornado'); ?>"></span>
                </label>
                <div class="color-picker">
                    <?php $color_val = get_option('dark_typography_color'); ?>
                    <input type="text" name="dark_typography_color" value="<?php echo $color_val; ?>" placeholder="<?php echo $color_val; ?>">
                    <div class="color-prev" style="background-color:<?php echo $color_val; ?>"></div>
                </div>
            </div>
        </div>
