...
<div class="options-panel">
    ...
    <h2 class="panel-title">
        <?php echo __('Blog Options','tornado'); ?>
...
<div class="options-panel">
    <!-- Panel Title -->
    <h2 class="panel-title">
        <?php echo __('Slider Options','tornado'); ?>
        <label class="toggle-button">
...
<div class="options-panel">
    <!-- Panel Title -->
    <h2 class="panel-title">
        <?php echo __('Services Options','tornado'); ?>
        <label class="toggle-button">
...
<div class="options-panel">
    <!-- Panel Title -->
    <h2 class="panel-title">
        <?php echo __('Projects Options','tornado'); ?>
        <label class="toggle-button">
...
<div class="options-panel">
    <!-- Panel Title -->
    <h2 class="panel-title">
        <?php echo __('Portfolio Options','tornado'); ?>
        <label class="toggle-button">
...
<div class="options-panel">
    <!-- Panel Title -->
    <h2 class="panel-title">
        <?php echo __('Products Options','tornado'); ?>
        <label class="toggle-button">
...
<div class="options-panel">
    <!-- Panel Title -->
    <h2 class="panel-title">
        <?php echo __('Multimedia Options','tornado'); ?>
        <label class="toggle-button">
...
<div class="options-panel">
    <!-- Panel Title -->
    <h2 class="panel-title">
        <?php echo __('Testimonials Options','tornado'); ?>
        <label class="toggle-button">
...
<div class="options-panel">
    <!-- Panel Title -->
    <h2 class="panel-title">
        <?php echo __('Partners Options','tornado'); ?>
        <label class="toggle-button">
...
<div class="options-panel">
    <!-- Panel Title -->
    <h2 class="panel-title">
        <?php echo __('F.A.Q Options','tornado'); ?>
        <label class="toggle-button">
